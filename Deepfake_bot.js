            ...
            if (file_type == 'photo' && need_img == true) {
                ...
                download(curr_url, filename, function () {
                    ...
                    try {
                        ...
                        // execSync(
                        //     "curl -o C:\\Users\\Avinash\\Desktop\\vscoderepo\\first-order-model\\02.png " +
                        //     msg.attachments.array()[0].url
                        // );

                        console.log("here1");
                        execSync(
                            "cd C:\\Users\\Nandhakumar\\Documents\\GitHub\\first-order-model\\ && python C:\\Users\\Nandhakumar\\Documents\\GitHub\\first-order-model\\driving_code.py"
                        );

                        console.log("here2");
                        execSync(
                            'C:\\Users\\Nandhakumar\\AppData\\Local\\imageio\\ffmpeg\\ffmpeg-win32-v3.2.4.exe -i C:\\Users\\Nandhakumar\\Documents\\GitHub\\first-order-model\\twitter_out.mp4 -r 30 -filter:v "setpts=PTS/3" C:\\Users\\Nandhakumar\\Documents\\GitHub\\first-order-model\\twitter_out_fps.mp4 -y'
                        );

                        console.log("here3");
                        execSync(
                            "C:\\Users\\Nandhakumar\\AppData\\Local\\imageio\\ffmpeg\\ffmpeg-win32-v3.2.4.exe -i C:\\Users\\Nandhakumar\\Documents\\GitHub\\first-order-model\\twitter_out_fps.mp4 -i C:\\Users\\Nandhakumar\\Documents\\GitHub\\first-order-model\\vid.mp4 -c copy -map 0:v0 -map 1:a0 -shortest C:\\Users\\Nandhakumar\\Documents\\GitHub\\first-order-model\\twitter_final.mp4 -y"
                        );
